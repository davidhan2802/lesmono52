object frmselltourgroup: Tfrmselltourgroup
  Left = 172
  Top = 41
  BorderStyle = bsNone
  Caption = 'Tour Group'
  ...
  object Panelsales: TRzPanel
    ...
    object edtnum_jumlorg: TRzNumericEdit
      Left = 168
      Top = 157
      Width = 105
      Height = 24
    ...
    object cb_jenisbus: TRzComboBox
      Left = 456
      Top = 58
      Width = 137
      Height = 24
    ...
    object edtnum_presentfee: TRzNumericEdit
      Left = 456
      Top = 93
      Width = 137
      Height = 24
