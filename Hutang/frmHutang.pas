...
//  DataModule1.ZConnection1.Executedirect('update buymaster set lunas=0');
...
begin
  ...
  begin
    ...
    Close;
    SQL.Clear;
    SQL.Add('update buymaster set lunas=1, totalpayment=grandtotal ');
...
procedure TfrmHtg.FormShow(Sender: TObject);
begin
