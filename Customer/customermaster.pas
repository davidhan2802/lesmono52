...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('select IDcustomer from sellmaster');
    SQL.Add('where IDcustomer = ' + QuotedStr(DataModule1.ZQryCustomerIDcustomer.AsString) + ' ');
    Open;
    if not IsEmpty then
    begin
...
procedure TFrmcustomermaster.FormShow(Sender: TObject);
begin
