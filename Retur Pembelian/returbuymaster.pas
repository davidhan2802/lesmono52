...
begin
  ...
  DataModule1.ZQryreturitem.SQL.Text := 'select s.tanggal, s.faktur, s.supplier customer, d.nama, d.qtyretur, d.hargaBeli hargajual, (d.qtyretur*d.hargaBeli) tot, (d.diskon*d.qtyretur*d.hargaBeli*0.01) disc, d.subtotal, d.keterangan from returBelidetail d ' +
...
procedure TFrmRtrBeliMaster.FormShow(Sender: TObject);
begin
