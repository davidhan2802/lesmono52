...
function TfrmOpr.getNoFaktur : string;
...
begin
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('select max(right(faktur,4)) from operasional');
...
begin
  ...
  OprTxtNo.ReadOnly := usergroup='KASIR';
  RGkategori.Visible := usergroup<>'KASIR';
end;
