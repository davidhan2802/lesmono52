...
begin
 ...
 //     Datamodule1.ZConn2.ExecuteDirect('delete from usergroup where IDusergroup='+Datamodule1.ZQryUserGroupIDusergroup.AsString);
...
begin
 ...
 begin
   ...
   begin
 {   if (DataModule1.ZConnection1.Catalog='sparepart') then
        Datamodule1.ZConn2.ExecuteDirect('insert into usergroup (usergroup,isedit,isdel) values (' +
                                         QuotedStr(trim(edt_nama.Text)) +
                                         ',' + IntToStr(visedit) +
                                         ',' + IntToStr(visdel) +
                                         ')');     }
  ...
  //     if (DataModule1.ZConnection1.Catalog='sparepart') then
  //       Datamodule1.ZConn2.ExecuteDirect('insert into usergroupmenu values ('+ InttoStr(vIDUsergroup) + ','+ IntToStr(Longint(clb_Menus.Items.Objects[cgroup])) +')');
    end;
 ...
 begin
  ...
  begin
  {  if (DataModule1.ZConnection1.Catalog='sparepart') then
        Datamodule1.ZConn2.ExecuteDirect('update usergroup set '+
                                      'usergroup=' + QuotedStr(trim(edt_nama.Text)) +
                                      ',isedit=' + IntToStr(visedit) +
                                      ',isdel=' + IntToStr(visdel) +
                                      ' where IDusergroup=' + Datamodule1.ZQryUserGroupIDusergroup.AsString);     }
 ...
 //    if (DataModule1.ZConnection1.Catalog='sparepart') then
 //        Datamodule1.ZConn2.ExecuteDirect('delete from usergroupmenu where IDuserGroup='+ Datamodule1.ZQryUserGroupIDusergroup.AsString );
   ...
   //    if (DataModule1.ZConnection1.Catalog='sparepart') then
   //        Datamodule1.ZConn2.ExecuteDirect('insert into usergroupmenu values '+
   //          '('+ Datamodule1.ZQryUserGroupIDusergroup.AsString + ','+ IntToStr(Longint(clb_Menus.Items.Objects[cgroup])) +')');
