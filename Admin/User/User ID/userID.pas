...
begin
 ...
 //     Datamodule1.ZConn2.ExecuteDirect('delete from user where IDuser='+DataModule1.ZQryUserIDuser.AsString);
...
begin
 ...
 begin
   ...
   begin
 {   if (DataModule1.ZConnection1.Catalog='sparepart') then
        DataModule1.ZConn2.ExecuteDirect('insert into user (username,password,IDusergroup,usergroup,tglnoneffective) values (' +
                                                  QuotedStr(edt_nama.Text) +
                                                  ',' + QuotedStr(edt_passwd.Text) +
                                                  ',' + IntToStr(Longint(cb_usergroup.Items.Objects[cb_usergroup.ItemIndex])) +
                                                  ',' + QuotedStr(cb_usergroup.Text) +
 ...
 begin
  ...
  begin
  {  if (DataModule1.ZConnection1.Catalog='sparepart') then
        DataModule1.ZConn2.ExecuteDirect('update user set username=' + QuotedStr(edt_nama.Text) +
                                                  ',password=' + QuotedStr(edt_passwd.Text) +
                                                  ',IDusergroup=' + IntToStr(Longint(cb_usergroup.Items.Objects[cb_usergroup.ItemIndex])) +
                                                  ',usergroup=' + QuotedStr(cb_usergroup.Text) +
                                                  ',tglnoneffective=' + tglne +
                                                  ' where IDuser=' + DataModule1.ZQryUserIDuser.AsString);   }
...
procedure TFrmUserID.FormShow(Sender: TObject);
begin
  Color := $0092C9C9;
