object frmProd: TfrmProd
  ...
  object PanelProd: TRzPanel
    ...
    object ProdTxtKategori: TRzComboBox
      Left = 120
      Top = 132
      Width = 169
      Height = 24
      ...
      ParentFont = False
      TabOrder = 5
      OnChange = ProdTxtKategoriChange
    end
    ...
    object ProdTxtQty: TRzNumericEdit
      Left = 448
      Top = 340
      Width = 169
      Height = 24
    ...
    object ProdTxtHrgBeli: TRzNumericEdit
      ...
      ParentFont = False
      TabOrder = 14
      OnChange = edtnum_marginChange
      DisplayFormat = ',0;(,0)'
    end
    object ProdTxtQtyrsk: TRzNumericEdit
      Left = 448
      Top = 364
      Width = 169
      Height = 24
    ...
    object dte_expdate: TRzDateTimeEdit
      Left = 120
      Top = 316
      Width = 169
      Height = 24
    ...
    object edtnum_feebiro: TRzNumericEdit
      Left = 488
      Top = 196
      Width = 153
      Height = 24
    ...
    object edtnum_feedrivertl: TRzNumericEdit
      Left = 488
      Top = 244
      Width = 153
      Height = 24
    ...
    object edtnum_margin: TRzNumericEdit
      Left = 232
      Top = 220
      Width = 57
      Height = 24
    ...
    object edtnum_feerent: TRzNumericEdit
      Left = 488
      Top = 268
      Width = 153
      Height = 24
